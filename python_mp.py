...
class GuestInfoWindow(tk.Toplevel):
    def __init__(self, parent, room_number, hotel_app):
        ...
        # Title label
        self.title_label = tk.Label(self, text="DETAILS OF THE GUEST:", font=("Arial", 24), bg="white", fg="brown")
        self.title_label.place(relx=0.5, rely=0.1, anchor="center")

        # Name label and entry
        self.name_label = tk.Label(self, text="Name:", font=("Arial", 20), bg="#8B4513", fg="white")
        self.name_label.place(relx=0.5, rely=0.2, anchor="center")
        self.name_entry = tk.Entry(self, font=("Arial", 18), fg="black", bg="#FFFF99")
        self.name_entry.place(relx=0.5, rely=0.25, anchor="center")

        # Address label and entry
        self.address_label = tk.Label(self, text="Address:", font=("Arial", 20), bg="#8B4513", fg="white")
        self.address_label.place(relx=0.5, rely=0.35, anchor="center")
        self.address_entry = tk.Entry(self, font=("Arial", 18), fg="black", bg="#FFFF99")
        self.address_entry.place(relx=0.5, rely=0.4, anchor="center")

        # Aadhar Number label and entry
        self.aadhar_label = tk.Label(self, text="Aadhar Number:", font=("Arial", 20), bg="#8B4513", fg="white")
        self.aadhar_label.place(relx=0.5, rely=0.5, anchor="center")
        self.aadhar_entry = tk.Entry(self, font=("Arial", 18), fg="black", bg="#FFFF99")
        self.aadhar_entry.place(relx=0.5, rely=0.55, anchor="center")

        # Phone Number label and entry
        self.phone_label = tk.Label(self, text="Phone Number:", font=("Arial", 20), bg="#8B4513", fg="white")
        self.phone_label.place(relx=0.5, rely=0.65, anchor="center")
        self.phone_entry = tk.Entry(self, font=("Arial", 18), fg="black", bg="#FFFF99")
        self.phone_entry.place(relx=0.5, rely=0.7, anchor="center")

        # Extra Number label and entry
        self.extra_label = tk.Label(self, text="Extra Number:", font=("Arial", 20),bg="#8B4513", fg="white" )
        self.extra_label.place(relx=0.5, rely=0.8, anchor="center")
        self.extra_entry = tk.Entry(self, font=("Arial", 18), fg="black", bg="#FFFF99")
        self.extra_entry.place(relx=0.5, rely=0.85, anchor="center")

        # Submit button
        self.submit_button = tk.Button(self, text="SUBMIT", command=self.submit_guest_info, font=("Helvetica", 18), bg="#8B4513", fg="white")
        self.submit_button.place(relx=0.5, rely=0.95, anchor="center")
...
class PaymentWindow(tk.Toplevel):
    def __init__(self, parent, room_number, hotel_app):
        ...
        self.payment_label = tk.Label(self, text="SELECT MODE OF PAYMENT:", font=("Helvetica", 20), bg="#8B4513", fg="white")
        ...
        self.payment_menu.config(font=("Arial", 18), fg="black", bg="#FFFF99")
        self.payment_menu["menu"].config(font=("Arial", 18), fg="black", bg="#FFFF99")
        self.payment_menu.place(relx=0.5, rely=0.4, anchor="center")

        self.proceed_button = tk.Button(self, text="Proceed", command=self.proceed_payment,font=("Helvetica", 20), bg="#8B4513", fg="white" )
...
class UpiWindow(tk.Toplevel):
    def __init__(self, parent, hotel_app):
        ...
        # Title label
        self.title_label = tk.Label(self, text="ONLINE PAYMENT DETAILS:", font=("Arial", 24), bg="white", fg="brown")
        self.title_label.place(relx=0.5, rely=0.2, anchor="center")

        # Enter UPI ID label
        self.upi_label = tk.Label(self, text="Enter UPI ID:", font=("Helvetica", 22), bg="#8B4513", fg="white")
        self.upi_label.place(relx=0.5, rely=0.4, anchor="center")

        # UPI Entry field
        self.upi_entry = tk.Entry(self, font=("Arial", 20), fg="black", bg="#FFFF99")
        self.upi_entry.place(relx=0.5, rely=0.5, anchor="center")

        # Submit button
        self.submit_button = tk.Button(self, text="Submit", command=self.submit_upi, font=("Helvetica", 22), bg="#8B4513", fg="white")
...
class HotelManagementApp(tk.Toplevel):
    def __init__(self, master):
        ...
        # Load and display background image
        bg_image = Image.open("C:\\Users\\Vishal\\Downloads\\miniproject.python\\bg.jpg")
